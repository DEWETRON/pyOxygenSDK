...
## About
Python port of parts of the C++ OXYGEN-SDK.

A package containing wheels for all suported python versions, a getting started guide and examples is available for download in the Releases section.
